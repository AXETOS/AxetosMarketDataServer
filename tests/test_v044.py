...
def test_release_metadata() -> None:
    assert __version__ == "0.61.2"
    assert 'version = "0.61.2"' in (ROOT / "pyproject.toml").read_text(encoding="utf-8")
    assert "## Version 0.61.2" in (ROOT / "README.md").read_text(encoding="utf-8")
